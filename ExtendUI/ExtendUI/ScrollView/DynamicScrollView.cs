namespace ExtendUI.ScrollView
{
    ...
    public abstract class DynamicScrollView : UIBehaviour
    {
        ...
        protected override void Awake()
        {
            ...
            this.itemPrototype.setSizeFromTopNormalize();
            base.Awake();
        ...
        protected  void OnInit()
        {
            ...
            this._prevTotalItemCount = this.totalItemCount.Count;
        ...
        private void Update()
        {
            if (totalItemCount == null)
                return;
            if (this.totalItemCount.Count != this._prevTotalItemCount)
            {
        ...
        private void resizeContent()
        {
            ...
            if (this._direction == Direction.Vertical)  size.y = this._itemSize * this.totalItemCount.Count - intervalSize;
            else                                        size.x = this._itemSize * this.totalItemCount.Count - intervalSize;
        ...
        private void updateItem(int index, GameObject itemObj)
        {
            ...
            if (index < 0 || index >= this.totalItemCount.Count)
            {
            ...
            else
            {
                ...
                if (item != null)
                {
                    item.onUpdateItem(index, totalItemCount);
                }
                else
                {
                    Debug.LogWarning("The Item Can't Find IDynamicScrollViewItem Scprit!");
                } 
            }
        }
